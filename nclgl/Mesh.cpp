...
Mesh* Mesh::GenerateTriangle()
{
	...
	m->vertices[0] = Vector3(0.0f, 0.25f, 0.0f);
...
Mesh* Mesh::GeneratePolygon()
{
	...
	m->vertices[1] = Vector3(0.25f, -0.25f, 0.0f);
	m->vertices[2] = Vector3(-0.25f, -0.25f, 0.0f);
	m->vertices[3] = Vector3(0.0f, -0.75f, -0.25f);
	m->vertices[4] = Vector3(-0.25f, -0.75f, -0.5f);
	...
	m->colours[4] = Vector4(1.0f, 1.0f, 0.0f, 1.0f);
